...
const HomeContent = () => {
  return (
    ...
    >
      ...
      >
        <div
          className=" flex flex-col items-center lg:items-start gap-6 w-full max-w-155"
        >
          <p
            className=" font-[Inter] font-light italic text-[#FFFFFF] text-center lg:text-start text-[20px] leading-7.5 lg:text-[27px] lg:leading-[36.72px] tracking-[-1.2px]"
          >
        ...
        <p
          className=" font-[Inter] font-normal text-white text-center lg:text-end leading-none text-[50px] tracking-[-2px] sm:text-[70px] md:text-[90px] md:tracking-[-6px] lg:text-[130px] lg:tracking-[-10px] xl:text-[154px] xl:tracking-[-13px]
        "
        >
          Everything
        </p>
