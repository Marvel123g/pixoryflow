...
//         <p
//           className="bg-[#FFFFFF1A] font-normal text-[13px] leading-5 p-4 rounded-[10px] max-w-[500px] sm:text-[14px] md:text-[15px]"
//         >
//           A POWERFUL WEB3 INFRASTRUCTURE THAT ALLOWS YOU TO CREATE,
//           TRADE, AND MANAGE DIGITAL ASSETS WITH FULL TRANSPARENCY
//           AND SECURITY.
...
//           <span className="font-normal text-[12px] sm:text-[13px] md:text-[14px] tracking-[-0.56px] text-white">
//             Fast. Secure. Permissionless.
//           </span>
//         </div>
//       </div>
...
//         <p className="font-[Inter] text-white font-normal leading-[0.9] text-[70px] sm:text-[100px] md:text-[140px] lg:text-[180px] tracking-[-0.02em]">
//           Decentralize
//         </p>
//       </div>
...
//           <p className="font-[Inter] font-light italic text-[#FFFFFF] text-center lg:text-left text-[20px] leading-[1.4] lg:text-[28px] tracking-[-0.02em]">
//             Build, scale, and innovate with blockchain technology.
//             Our platform enables secure, transparent, and
//             permissionless digital experiences for the future of
//             the internet.
...
//           <button className="px-10 py-3 rounded-[87px] font-[Inter] font-light text-[16px] tracking-[-0.48px] text-[#090A0D] bg-[#FFFFFF] transition-all duration-300 ease-out hover:scale-105 cursor-pointer w-full sm:w-auto text-center">
//             Connect Wallet
//           </button>
//         </div>

//         <div>
//           <p className="font-[Inter] font-normal text-white text-center lg:text-right leading-[0.9] text-[70px] sm:text-[100px] md:text-[140px] lg:text-[160px] tracking-[-0.02em]">
//             Everything
//           </p>
//         </div>
//       </div>
